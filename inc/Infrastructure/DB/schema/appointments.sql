...
CREATE TABLE IF NOT EXISTS {{appointment_table}} (
    ...
    total_fee DECIMAL(10,2) GENERATED ALWAYS AS (consultation_fee + service_fee) STORED,
...
--     FOREIGN KEY (service_post_id) REFERENCES wp_posts(ID),
    ...
    INDEX idx_doctor_date (doctor_post_id, appointment_date),
    ...
    INDEX idx_doctor_date_status (doctor_post_id, appointment_date, status),
